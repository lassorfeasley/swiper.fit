...
export function subject({ inviterName }) {
  return `Become ${inviterName}'s client on Swiper`;
}

export default function ClientInvitation({ inviterName = 'John Smith' }) {
  ...
  return React.createElement(
    ...
    // Heading
    React.createElement('div', { style: titleStyle }, `${inviterName} wants you to be his client on Swiper`),
    // Body
