...
const StartWorkoutCard = ({ 
  ...
  return (
    <div
      ...
      className="CardWrapper w-full min-h-14 bg-white rounded-lg shadow-[0px_0px_8px_0px_rgba(229,229,229,1.00)] outline outline-1 outline-offset-[-1px] outline-neutral-neutral-300 backdrop-blur-[1px] flex justify-start items-center gap-2.5 overflow-hidden cursor-pointer"
