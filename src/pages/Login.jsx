    ...
    <div>
      ...
      <div className="w-full px-4 lg:w-1/3 mx-auto h-[782px] flex flex-col justify-center items-center">
        <div className="flex flex-col gap-4 w-full">
          <div className="text-slate-600 text-2xl font-normal font-['Space_Grotesk'] leading-9">
            Sign in
          </div>
          ...
          />
          {/* 
            TODO: ADD THIS BACK IN WHEN WE HAVE A FORGOT PASSWORD FLOW
            <div
              data-layer="Forgot password?"
              className="ForgotPassword self-stretch justify-center text-slate-600 text-base font-normal font-['Space_Grotesk'] leading-normal"
            >
              Forgot password?
            </div> */}
          <Button
