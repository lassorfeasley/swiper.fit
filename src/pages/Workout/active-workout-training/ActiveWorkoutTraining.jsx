...
const ActiveWorkoutTraining = ({
  ...
  // Handle set completion for training section
  ...
  // Handle adding new exercise to training
      ...
      const { data: workoutExercises, error: workoutExerciseError } =
        await supabase
          ...
          .insert({
            ...
            section_override: section, // Force this exercise into training section
          })
          .select("*");
...
export default ActiveWorkoutTraining;
