  ...
  variants: {
    variant: {
      ...
      outline:
        ...
        "primary-action": "w-full bg-neutral-neutral-700 text-white hover:bg-neutral-neutral-600 rounded-lg border border-neutral-300 px-3 py-0 text-left text-xs font-bold font-['Be_Vietnam_Pro'] uppercase leading-5 tracking-wide overflow-hidden h-12 min-h-[48px] justify-start items-center",
    },
  },
  defaultVariants: {
    variant: "default",
