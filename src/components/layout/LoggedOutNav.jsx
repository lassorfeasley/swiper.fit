...
export default function LoggedOutNav({ showAuthButtons = true }) {
  ...
  return (
    <>
      ...
      <div className="md:hidden w-full flex-shrink-0 bg-white">
        {showAuthButtons && (
      ...
      <div className="hidden md:flex w-full h-11 pl-5 border-b border-neutral-neutral-300 justify-between items-center bg-white">
        <button 
          onClick={() => navigate('/')}
