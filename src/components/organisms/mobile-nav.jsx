...
const MobileNav = () => {
  ...
  return (
    <nav
      className="mobile-nav self-stretch inline-flex flex-col justify-end items-center fixed bottom-0 left-0 right-0 w-full md:hidden z-[100] bg-[linear-gradient(to_bottom,rgba(255,255,255,0)_0%,rgba(255,255,255,0)_10%,rgba(255,255,255,0.5)_40%,rgba(255,255,255,1)_80%,rgba(255,255,255,1)_100%)]"
    >
      {isWorkoutActive ? (
        <ActiveWorkoutNav />
      ) : (
        <div className="self-stretch px-5 pb-4 flex flex-col justify-start items-start gap-2.5">
          <div className="self-stretch h-16 bg-white/80 rounded-[100px] shadow-[0px_0px_8px_0px_rgba(229,229,229,1.00)] backdrop-blur-[1px] inline-flex justify-between items-center">
            {navItems.map((item) => {
