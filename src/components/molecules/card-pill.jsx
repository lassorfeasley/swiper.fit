...
const CardPill = ({
  ...
  // Shared pill classes
  const pillClass = `px-2 py-0.5 rounded-[20px] flex items-center ${
    complete ? "bg-slate-200" : "bg-gray-200"
  } ${editable ? "cursor-pointer" : ""} ${className}`.trim();
  ...
  return (
    ...
    >
      ...
      {set_type === "timed" && (
        <span
          data-layer="lucide"
          className="Lucide size-4 relative overflow-hidden mr-1"
        >
          <svg
            width="14"
            height="14"
