    ...
    <div className="p-4">
      ...
      <div className="mt-6">
        <p className="text-sm text-gray-600">
          You can find more icons at <a href="https://fonts.google.com/icons" className="text-blue-500 underline" target="_blank" rel="noopener noreferrer">Google Fonts Icons</a>
        </p>
      </div>
    </div>
  );
