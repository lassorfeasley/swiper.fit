...
const AddNewExerciseForm = ({
  ...
  return (
    <form
      className="Editexerciseform w-full max-w-sm box-border inline-flex flex-col justify-start items-start gap-6"
      onSubmit={handleSave}
    >
      ...
      <div className="Frame13 self-stretch flex flex-col justify-start items-start gap-3">
        ...
        <div className="NumericField self-stretch h-20 flex flex-col justify-start items-start gap-1">
          <div className="FieldLabel justify-start text-slate-600 text-base font-normal font-['Space_Grotesk'] leading-normal">
            Sets
          </div>
          <NumericInput
            value={sets}
      ...
      <div className="Frame7 self-stretch flex flex-col justify-start items-start gap-3">
        <SwiperButton
          type="submit"
          className="Swiperbuttonutilitywrapper self-stretch h-10 px-4 py-2 bg-slate-600 rounded-sm inline-flex justify-center items-center gap-2.5"
        >
        ...
        {formPrompt === "Edit exercise" && (
          <SwiperButton
            ...
            variant="destructive"
            onClick={onDelete}
            className="Swiperbuttonutilitywrapper self-stretch h-10 px-4 py-2 bg-red-400 rounded-sm inline-flex justify-center items-center gap-2.5"
          >
            Delete exercise
          </SwiperButton>
        )}
