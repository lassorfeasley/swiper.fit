...
const Reorder_Card = ({ value, children, className = '' }) => {
  return (
    <Reorder.Item
      value={value}
      className={`flex items-center rounded-2xl bg-white p-0 min-h-[80px] relative shadow-sm ${className}`}
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center h-full py-2 px-2 select-none">
        <div className="cursor-grab text-[var(--Dark-grey)] opacity-70 hover:opacity-100">
