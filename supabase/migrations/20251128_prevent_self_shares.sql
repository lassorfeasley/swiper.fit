-- ============================================================================
-- Prevent self-sharing relationships
-- 1. Ensure account_shares cannot contain owner==delegate rows
-- 2. Harden accept_invitation RPC with a self-share guard
-- ============================================================================

begin;

-- --------------------------------------------------------------------------
-- Add table-level guard
-- --------------------------------------------------------------------------
alter table public.account_shares
  add constraint if not exists account_shares_owner_not_delegate
  check (
    owner_user_id is null
    or delegate_user_id is null
    or owner_user_id <> delegate_user_id
  );

-- --------------------------------------------------------------------------
-- Update accept_invitation RPC
-- --------------------------------------------------------------------------
